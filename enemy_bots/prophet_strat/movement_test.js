...
exports.get_next_step_astar_fuel = function(currentLocation,destination,map,previousPathsTaken,radius){
  var test = this.get_next_step_astar(currentLocation,destination,map,previousPathsTaken,radius,1);
  return test;
}

exports.get_next_step_astar_turn = function(currentLocation,destination,map,previousPathsTaken,radius){
//console.log("HEHREH");
  var test = this.get_next_step_astar(currentLocation,destination,map,previousPathsTaken,radius,0);
  //console.log(test);
  return test;
}
