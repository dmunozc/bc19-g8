...
exports.findClosestCastle = function(myLocationX,mylocationY,possibleCastleLocations,map,rob){
...
exports.getRandomPath = function(direction,openPaths){
...
exports.getPossibleSteps = function(coor,map){
...
exports.getDirection = function(coor1,coor2){
...
//only single step
exports.getNextStep = function(currentLocation,destination,map){
...
exports.findPathToCoordinate = function(origin,destination,map){
